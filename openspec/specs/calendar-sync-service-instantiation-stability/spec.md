# calendar-sync-service-instantiation-stability Specification

## Purpose
TBD - created by archiving change fix-calendar-sync-service-constructor-injection. Update Purpose after archive.
## Requirements
