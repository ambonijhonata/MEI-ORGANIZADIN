...
class CalendarPaymentSummaryTest {
    ...
    void shouldClassifyNoPaymentAsNone() {
        CalendarPaymentSummary summary = CalendarPaymentSummary.fromAmounts(BigDecimal.ZERO, new BigDecimal("50.00"));
    ...
    void shouldClassifyPartialPaymentAsPartial() {
        CalendarPaymentSummary summary = CalendarPaymentSummary.fromAmounts(new BigDecimal("20.00"), new BigDecimal("50.00"));
    ...
    void shouldClassifyFullPaymentAsPaid() {
        CalendarPaymentSummary summary = CalendarPaymentSummary.fromAmounts(new BigDecimal("50.00"), new BigDecimal("50.00"));
